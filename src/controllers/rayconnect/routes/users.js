...
router.post('/create-customer', auth, authorize('agent', 'super-agent'), async (req, res) => {
  ...
  try {
    ...
    const newCustomer = await query(
      `INSERT INTO ray_users (username, email, password, role, phone_number, state, city, address, landmark, created_by, super_agent_id, name, id_number) 
       VALUES ($1, $2, $3, 'customer', $4, $5, $6, $7, $8, $9, $10, $11, $12) 
